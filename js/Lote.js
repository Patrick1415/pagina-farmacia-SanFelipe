                  ...
                  <div class="row">
                    <div class="col-7">
                      ...
                      <ul class="ml-4 mb-0 fa-ul">
                        ...
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-copyright"></i></span> Tipo de lote: ${lote.tipo}</li>
   ...
   $(document).on('click','.borrar',(e)=>{
    ...
    const swalWithBootstrapButtons = Swal.mixin({
     ...
     swalWithBootstrapButtons.fire({
       title: "Estas seguro de Eliminar "+id+"?",
          ...
          $.post('../controlador/LoteController.php',{id,funcion},(response)=>{
             if(response=='borrado'){
                ...
                swalWithBootstrapButtons.fire({
                   ...
                   text: 'El Lote '+id+' no se ha podido borrar, esta en uso!',
                   icon: "error"
                 });
             }
          })
