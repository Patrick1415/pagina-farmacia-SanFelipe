  ...
  function buscar_prov(consulta){
     ...
     $.post('../controlador/ProveedorController.php',{consulta,funcion},(response)=>{
        ...
        proveedores.forEach(proveedor => {
            template+=`
            <div provId="${proveedor.id}" provNombre="${proveedor.nombre}" provDireccion="${proveedor.direccion}" provTelefono="${proveedor.telefono}" provCorreo="${proveedor.correo}" provAvatar="${proveedor.avatar}" class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
            <div class="card bg-light d-flex flex-fill">
                ...
                <div class="row">
                  <div class="col-7">
                    ...
                    <ul class="ml-4 mb-0 fa-ul text-muted">
                      <li class="small"><span class="fa-li"><i class="fas fa-lg fa-mortar-pestle"></i></span> Dirección: ${proveedor.direccion}</li>
              ...
              <div class="card-footer">
                <div class="text-right">
                  <button class="avatar btn btn-sm btn-info" title="Cambiar Imagen" type="button" data-toggle="modal" data-target="#cambiologo">
          ...
          $.post('../controlador/ProveedorController.php',{id,funcion},(response)=>{
             ...
             if(response=='borrado'){
                ...
                swalWithBootstrapButtons.fire({
                   ...
                   text: 'El Proveedor '+nombre+' no se ha podido borrar, esta en uso en un Lote!',
                   icon: "error"
                 });
             }
          })
