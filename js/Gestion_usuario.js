$(document).ready(function(){
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      ...
                      <p class="text-muted text-sm"><b>Especialista: </b> ${usuario.adicional}</p>
                ...
                <div class="card-footer">
                  <div class="text-right">`;
                      if(tipo_usuario == 3){
                         ...
                         if(usuario.tipo_usuario == 1){
                          template+=`
                          <button class="descender btn btn-dark ml-1" type="button" data-toggle="modal" data-target="#confirmar">
  ...
  $('#form-crear').submit(e=>{
     ...
     $.post('../controlador/UsuarioController.php',{nombre,apellido,dni,edad,pass,funcion},(response)=>{
        if(response =='add'){
          $('#add').hide('slow');
          $('#add').show(1000);
          $('#add').hide(2000);
