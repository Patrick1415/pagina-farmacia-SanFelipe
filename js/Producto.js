$(document).ready(function(){
    ...
    function rellenar_tipos(){
     ...
     $('#form-crear-producto').submit(e=>{
        ...
        $.post('../controlador/ProductoController.php',{funcion,id,nombre,concentracion,adicional,concentracion,precio,laboratorio,tipo,presentacion},(response)=>{
           if(response == 'add'){
            $('#add').hide('slow');
            $('#add').show(1000);
            $('#add').hide(2000);
                  ...
                  <div class="row">
                    <div class="col-7">
                      ...
                      <ul class="ml-4 mb-0 fa-ul text-muted">
                        ...
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-copyright"></i></span> Tipo de Producto: ${producto.tipo}</li>
            ...
            $.post('../controlador/ProductoController.php',{id,funcion},(response)=>{
               ...
               if(response=='borrado'){
                  ...
                  swalWithBootstrapButtons.fire({
                     ...
                     text: 'El Producto '+nombre+' no se ha podido borrar, esta en uso en un Lote!',
                     icon: "error"
                   });
               }
            })
