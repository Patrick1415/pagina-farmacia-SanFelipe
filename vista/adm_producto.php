                ...
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <div class="alert alert-success text-center" id="add-lote" style='display:none;'>
                            <span><i class="fas fa-check m-1"></i>Se agrego un nuevo Lote!</span>
                        </div>
                        ...
                        <form id="form-crear-lote">
                           ...
                           <div class="form-group">
                               ...
                               <input id="stock" type="number" class="form-control" placeholder="Ingresar Stock">
                           </div>
                           <div class="form-group">
                               <label for="vencimiento">Fecha de Vencimiento</label>
                               <input id="vencimiento" type="date" class="form-control" placeholder="Ingresar Fecha de Vencimiento">
                           </div>
                ...
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <div class="alert alert-success text-center" id="add" style='display:none;'>
                            <span><i class="fas fa-check m-1"></i>Se agrego un nuevo Producto</span>
                        </div>
                        <div class="alert alert-danger text-center" id="noadd" style='display:none;'>
                            <span><i class="fas fa-times m-1"></i>El producto ingresado, ya existe!</span>
                        </div>
                        <div class="alert alert-success text-center" id="edit_prod" style='display:none;'>
                            <span><i class="fas fa-check m-1"></i>Se ha editado el producto, correctamente!</span>
                        </div>
                        <form id="form-crear-producto">
                           <div class="form-group">
                               <label for="nombre_producto">Nombre</label>
                               <input id="nombre_producto" type="text" class="form-control" placeholder="Ingresar Nombres" required>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                               ...
                               <input id="adicional" type="text" class="form-control" placeholder="Ingresar información Adicional">
                           </div>
                           <div class="form-group">
                               <label for="precio">Precio</label>
                               <input id="precio" type="number" class="form-control" value='1' placeholder="Ingresar Precio del Producto" required>
                           </div>
                           <div class="form-group">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><b>Gestor de Productos<button id="button-crear" type="button" data-toggle="modal" data-target="#crearproducto" class="btn bg-gradient-primary ml-2">Crear Producto</button></b></h1>
                    </div>
                    <div class="col-sm-6">
