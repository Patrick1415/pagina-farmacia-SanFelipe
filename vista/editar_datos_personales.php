    ...
    <div class="modal fade" id="cambiofoto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        <img id="avatar1" src="../img/ardilla.jpg" class="profile-user-img img-fluid img-circle">
                    </div>
                    <div class="text-center">
                        <b>
                            <?php
                    ...
                    <div class="alert alert-danger text-center" id="noedit" style="display: none;">
                        <span><i class="fas fa-times m-1"></i>El avatar no es correcto</span>
                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="card card-success card-outline">
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        <img id="avatar2" src="../img/ardilla.jpg" class="profile-user-img img-fluid img-circle">
                                    </div>
                                    <div class="text-center">
                                        <button type="button" data-toggle="modal" data-target="#cambiofoto" class="btn btn-primary btn-sm mt-1">
                                            Cambiar avatar
                                        </button>
                                    </div>
                                    ...
                                    <ul class="list-group list-group-unbordered mb-3">
                                        <li class="list-group-item">
                                            <b style="color: #0B7300;">Edad</b><a id="edad" class="float-right">18</a>
                                        </li>
                                        <li class="list-group-item">
                                            <b style="color: #0B7300;">DNI</b><a id="dni_us" class="float-right">18</a>
                                        </li>
                                        <li class="list-group-item">
                                            <b style="color: #0B7300;">Tipo Usuario</b>
                                            <span id="us_tipo" class="badge float-right">Administrador</span>
                                        </li>
                                        <button data-toggle="modal" data-target="#cambiocontra" type="button" class="btn btn-block btn-outline-warning btn-sm"><b>Cambiar password</b></button>
                                    </ul>
                                </div>
                            </div>
                            <div class="card card-success">
                                ...
                                <div class="card-body">
                                    ...
                                    <p id="telefono_us" class="text-muted">343434545</p>
                                    <strong style="color: #0B7300">
                                        <i class="fas fa-map-marker-alt mr-1"></i>Residencia
                                    </strong>
                                    <p id="residencia_us" class="text-muted">343434545</p>
                                    <strong style="color: #0B7300">
                                        <i class="fas fa-at mr-1"></i>Correo
                                    </strong>
                                    <p id="correo_us" class="text-muted">343434545</p>
                                    <strong style="color: #0B7300">
                                        <i class="fas fa-smile-wink mr-1"></i>sexo
                                    </strong>
                                    <p id="sexo_us" class="text-muted">343434545</p>
                                    <strong style="color: #0B7300">
                                        <i class="fas fa-pencil-alt mr-1"></i>Informacion adicional
                                    </strong>
                                    <p id="adicional_us" class="text-muted">343434545</p>
